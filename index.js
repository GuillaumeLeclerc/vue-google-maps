...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PlaceInput = exports.Rectangle = exports.Circle = exports.Polyline = exports.InfoWindow = exports.Cluster = exports.Marker = exports.Map = exports.loaded = exports.load = undefined;
	...
	var _cluster = __webpack_require__(55);
	
	var _cluster2 = _interopRequireDefault(_cluster);
	
	var _infoWindow = __webpack_require__(59);
	
	var _infoWindow2 = _interopRequireDefault(_infoWindow);
	
	var _polyline = __webpack_require__(63);
	...
	var _placeInput = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setUp = false;
	var loadingDefered = Q.defer();
	
	var loaded = exports.loaded = loadingDefered.promise;
	 ...
	 * ```
	 */
	var load = exports.load = function load(apiKey, version, libraries) {
	  if (!setUp) {
	    ...
	    options['callback'] = 'vueGoogleMaps';
	
	    if (version) {
	      url = url + '&v=' + version;
	    }
	
	    var url = 'https://maps.googleapis.com/maps/api/js?' + (0, _keys2.default)(options).map(function (key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/daniel/vue-google-maps/src/components/map.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-47f37c8a&file=map.vue!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./map.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-47f37c8a&file=map.vue!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./map.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsBinder = __webpack_require__(50);
	
	var _eventsBinder2 = _interopRequireDefault(_eventsBinder);
	
	var _propsBinder = __webpack_require__(51);
	...
	var events = ['click', 'dblclick', 'rightclick', 'mousemove', 'mouseout', 'mouseover', 'drag', 'dragend', 'dragstart', 'idle', 'resize', 'tilesloaded', 'bounds_changed'];
	...
	var eventListeners = {
	  ...
	  'g-bounds_changed': function gBounds_changed() {
	    this.bounds = this.mapObject.getBounds();
	  },
	  'g-fitBounds': function gFitBounds(bounds) {
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    ...
	    _manager.loaded.then(function () {
	      ...
	      // creating the map
	      var copiedData = _lodash2.default.clone(_this.$data);
	      delete copiedData.options;
	      var options = _lodash2.default.clone(_this.options);
	      ...
	      (0, _propsBinder2.default)(_this, _this.mapObject, boundProps);
	
	      //binding events
	      (0, _eventsBinder2.default)(_this, _this.mapObject, events);
	
	      // update the bounds
	      _this.$emit('g-bounds_changed');
	
	      // wait before google maps has loaded the map to avoid bug with info windows
	      _this.$once('g-bounds_changed', function () {
	        // The map is now created
	        _this.mapCreatedDefered.resolve(_this.mapObject);
	      });
	    }, function (error) {
	      throw error;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (vueElement, googleMapsElement, props, options) {
	  ...
	  var afterModelChanged = _options.afterModelChanged;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/marker.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  data: function data() {
	    this.mapAvailableDefered = new _q2.default.defer();
	  ...
	  events: {
	    ...
	    'cluster-ready': function clusterReady(cluster, map) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/cluster.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(57); // /* vim: set softtabstop=2 shiftwidth=2 expandtab : */
	//
	// <template>
	// <slot></slot>
	// </template>
	...
	exports.default = {
	  props: props,
	  data: function data() {
	    this.mapReadyDefered = new _q2.default.defer();
	    this.mapReady = this.mapReadyDefered.promise;
	    this.clusterReadyDefered = new _q2.default.defer();
	  ...
	  ready: function ready() {
	    ...
	    this.mapReady.then(function (map) {
	      ...
	      _this.clusterObject = new MarkerClusterer(_this.mapObject, [], options);
	
	      _this.clusterReadyDefered.resolve(_this.clusterObject);
	  ...
	  events: {
	    ...
	    'register-marker': function registerMarker(element) {
	      var _this2 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/infoWindow.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationObserver = __webpack_require__(61);
	...
	var events = ['domready', 'closeclick'];
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    ...
	    if (this.$el.getElementsByClassName('you-will-never-find-this').length === 0) {
	      var innerChanged = function innerChanged() {
	        _this.content = _this.$el.innerHTML;
	      };
	      innerChanged();
	      this.disconnect = (0, _mutationObserver2.default)(this.$el, innerChanged);
	    }
	  ...
	  methods: {
	    ...
	    createInfoWindow: function createInfoWindow(map) {
	      ...
	      (0, _propsBinder2.default)(this, this.infoWindow, propsToBind);
	  ...
	  events: {
	    ...
	    'marker-ready': function markerReady(marker, map) {
	      var _this3 = this;
	
	      this.markerObject = marker.markerObject;
	      this.createInfoWindow(map);
	      marker.$on('g-click', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/polyline.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	  ...
	  events: {
	    'map-ready': function mapReady(map) {
	      ...
	      (0, _propsBinder2.default)(this, this.polyLineObject, localProps);
	      ...
	      var setupBind = function setupBind() {
	      ...
	      this.$watch('path', function () {
	        ...
	        _this.polyLineObject.setPath(_this.path);
	        setupBind();
	      }, {
	        deep: true
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/circle.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/rectangle.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/daniel/vue-google-maps/src/components/placeInput.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  props: props,
	  events: {
	    'g-place_changed': function gPlace_changed() {
