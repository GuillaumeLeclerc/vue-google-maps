...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Cluster = exports.Marker = exports.Map = exports.loaded = exports.load = undefined;
	...
	var _cluster = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsBinder = __webpack_require__(16);
	
	var _eventsBinder2 = _interopRequireDefault(_eventsBinder);
	
	var _propsBinder = __webpack_require__(17);
	...
	exports.default = {
	  ...
	  events: {
	    'register-component': function registerComponent(child) {
	      mapCreated.then(function (map) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  events: {
	    ...
	    'cluster-ready': function clusterReady(cluster, id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(23); // /* vim: set softtabstop=2 shiftwidth=2 expandtab : */
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    ...
	    this.mapReady.then(function (map) {
	      var options = _lodash2.default.clone(_this.$data);
	      _this.clusterObject = new MarkerClusterer(map, [], options);
	  ...
	  events: {
	    ...
	    'register-component': function registerComponent(element, type) {
	      var _this2 = this;
	
	      if (type === 'marker') {
	        this.clusterReady.then(function (cluster) {
	          element.$emit('cluster-ready', cluster, _this2.clusterId);
	        });
	      } else {
