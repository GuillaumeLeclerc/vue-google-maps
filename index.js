...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.InfoWindow = exports.Cluster = exports.Marker = exports.Map = exports.loaded = exports.load = undefined;
	...
	var _cluster = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var load = exports.load = function load(apiKey) {
	  if (!setUp) {
	    var googleMapScript = document.createElement('SCRIPT');
	    googleMapScript.setAttribute('src', 'https://maps.googleapis.com/maps/api/js?key=' + apiKey + '&callback=vueGoogleMapsInit');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/guillaume/dev/vue-google-maps/src/components/map.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-0e580c2c&file=map.vue!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./map.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-0e580c2c&file=map.vue!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./map.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsBinder = __webpack_require__(20);
	
	var _eventsBinder2 = _interopRequireDefault(_eventsBinder);
	
	var _propsBinder = __webpack_require__(21);
	...
	var events = ['click', 'dblclick', 'rightclick', 'mousemove', 'mouseout', 'mouseover', 'drag', 'dragend', 'dragstart', 'idle', 'resize', 'tilesloaded'];
	
	var registerChild = function registerChild(child) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/guillaume/dev/vue-google-maps/src/components/marker.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/guillaume/dev/vue-google-maps/src/components/cluster.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(24); // /* vim: set softtabstop=2 shiftwidth=2 expandtab : */
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/guillaume/dev/vue-google-maps/src/components/infoWindow.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationObserver = __webpack_require__(28);
	...
	exports.default = {
	  ...
	  methods: {
	    createInfoWindow: function createInfoWindow(map) {
	      ...
	      this.$watch('opened', function () {
	        if (_this2.opened) {
	          _this2.infoWindow.open(_this2.mapObject);
	        } else {
	  ...
	  events: {
	    ...
	    'marker-ready': function markerReady(cluster, map) {
	      var _this3 = this;
	
	      this.position = _lodash2.default.clone(cluster.position);
	      this.createInfoWindow(map);
	      cluster.$watch('position', function () {
	        _this3.position = _lodash2.default.clone(cluster.position);
	      }, { deep: true });
	      cluster.$on('g-click', function () {
